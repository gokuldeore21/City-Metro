<?php
   ...
   if(!isset($_SESSION['uidorPhone'])){
	...
	$data = [
		...
		"amount"            => $amount,
		"name"              => "Rail Pune",
		"description"       => "Dummy Pune railway ticket booking site.",
...
<body>
   ...
   <div class="d-none" id="main">
      <nav id="navbar" class="navbar navbar-expand-lg navbar-dark fixed-top shadow">
         <div class="container">
            <a class="navbar-brand" href="index.php">CityMetro</a>
      ...
      <section class="banner-area jumbotron position-relative" id="home">
         ...
         <div class="container">
            <div class="banner-content position-relative d-flex flex-column align-items-center justify-content-center">
               <h2 class="text-white display-4">Welcome to CityMetro</h2>
               <p class="text-white mt-3 mb-5">
                  Quick Pune Local Train Booking
               </p>
            </div>
         </div>
      </section>
                     ...
                     <div class="col-lg-4 text-white">
                        ...
                        <div class="form-group">
                           ...
                           <select name="via" class="form-control" id="via" required>
                              ...
                              <option value="Thane">Nigdi</option>
                              <option value="Vashi">Swargate</option>
                              <option value="Snpd">Pune City</option>
                              <option value="Dadar">Shivaji Nagar</option>
                           </select>
                        </div>
                     </div>
                     <div class="col-lg-4 text-white">
         ...
         <div class="container">
            <div class="row d-flex justify-content-center">
               <div class="menu-content pb-60 col-lg-8">
                  <div class="title text-center">
                     <h2 class="mb-3">Why Choose CityMetro to Book Local Tickets ?</h2>
                  </div>
               </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
               ...
               <ul class="list-group my-4">
                  ...
                  <li class="list-group-item">Buy tickets directly from the webapp</li>
               </ul>
            </div>
         </div>
         <!--grid view end-->
